...
">Webcasting</a>
	...
	function pageSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Autowhen <select name="autowhen" id="autowhenpage">
				    <option value="all" selected>All</a>
			<option value="">
...
Weekly</a><option value="Never">Never</a>
				...
				<div class="table-list-search-form">Subwday <select name="subwday" id="subwdaypage">
				    <option value="all" selected>All</a>
			<option value="Friday">
...
Wednesday</a><option value="Sunday">Sunday</a>
				...
				<div class="table-list-search-form">Type <select name="type" id="typepage">
				    <option value="all" selected>All</a>
			<option value="CSS">CSS</a><option value="HTML">HTML</a><option value="JS">JS</a><option value="JSON">JSON</a><option value="RSS">RSS</a><option value="TEXT">TEXT</a><option value="XML">XML</a><option value="XSL">XSL</a><option value="email">Email</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
...
Other Image</a><option value="Genre">Genre</a><option value="Interview">Interview</a><option value="Thumbnail">Thumbnail</a>
			...
			<option value="something else">Something</a>
				...
				<div class="table-list-search-form">Language <select name="language" id="languagepost">
				    <option value="all" selected>All</a>
			<option value="English:French">English</a>
							</select></div>
				<div class="table-list-search-form">Section <select name="section" id="sectionpost">
				    <option value="all" selected>All</a>
			<option value="Section">Section</a>
							</select></div>
	...
	function presentationSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
			...
			<option value="J - Presented Papers and Talks">J - Presented Papers and Talks</a>
				...
				<div class="table-list-search-form">Type <select name="type" id="typepresentation">
				    <option value="all" selected>All</a>
	...
	function feedSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
			...
			<option value="A">Approved</a><option value="O">On Hold</a><option value="R">Retired</a><option value="B">Unlinked</a>
				...
				<div class="table-list-search-form">Table <select name="table" id="tablefeed">
				    <option value="all" selected>All</a>
