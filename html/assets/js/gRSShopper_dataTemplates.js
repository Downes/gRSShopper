	...
	function organizationSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categoryorganization">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Genre <select name="genre" id="genreorganization">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typeorganization">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
	...
	function fileSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typefile">
				    <option value="all" selected>All</a>
			<option value="Slides">Slides</a><option value="Thumbnail">Thumbnail</a><option value="Illustration">Illustration</a><option value="Audio">Audio</a><option value="Document">Document</a><option value="Enclosure">Enclosure</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function institutionSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categoryinstitution">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function feedSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Genre <select name="genre" id="genrefeed">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Status <select name="status" id="statusfeed">
				    <option value="all" selected>All</a>
			<option value="R">Retired</a><option value="B">Unlinked</a><option value="A">Approved</a><option value="O">On Hold</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typefeed">
				    <option value="all" selected>All</a>
			<option value="OAI">OAI</a><option value="RSS 2.0">RSS 2.0</a><option value="YouTube">YouTube</a><option value="Twitter">Twitter</a><option value="RSS 0.91">RSS 0.91</a><option value="JSON">JSON</a><option value="Facebook">Facebook</a><option value="RSS 1.0">RSS 1.0</a><option value="Atom">Atom</a><option value="Not Harvesting">Not Harvesting</a>
							</select></div>
				<div class="table-list-search-form">Section <select name="section" id="sectionfeed">
				    <option value="all" selected>All</a>
			<option value="podcast">Podcast</a><option value="journal">Journal</a><option value="news media">News Media</a><option value="blog">Blog</a><option value="other">Other</a>
							</select></div>
				<div class="table-list-search-form">Category <select name="category" id="categoryfeed">
				    <option value="all" selected>All</a>
			<option value="media">Media</a><option value="Ed Tech">Ed Tech</a><option value="cyberculture">Cyberculture</a><option value="news---ed">Education News</a><option value="edubloggers">Education Blogs</a><option value="Language">Language</a><option value="Higher Ed">Higher Ed</a><option value="ideas">Ideas</a><option value="K12">K12</a><option value="design">Design</a><option value="Corporate">Corporate</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function threadSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Extype <select name="extype" id="extypethread">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Twitterstatus <select name="twitterstatus" id="twitterstatusthread">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Status <select name="status" id="statusthread">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function viewSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultview">
				    <option value="all" selected>All</a>
	...
	function mediaSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typemedia">
				    <option value="all" selected>All</a>
			<option value="video">Video</a><option value="image">Image</a><option value="document">Document</a><option value="audio">Audio</a>
							</select></div>
				<div class="table-list-search-form">Mimetype <select name="mimetype" id="mimetypemedia">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function projectSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categoryproject">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function publicationSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categorypublication">
				    <option value="all" selected>All</a>
			<option value="Grant">Grant</a><option value="Chapter">Chapter</a><option value="Column">Column</a><option value="Report">Report</a><option value="Article">Article</a><option value=""></a><option value="Application">Application</a>
							</select></div>
				<div class="table-list-search-form">Catdetails <select name="catdetails" id="catdetailspublication">
				    <option value="all" selected>All</a>
			<option value=" "> </a><option value="Unrefereed">Unrefereed</a><option value="Refereed">Refereed</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typepublication">
				    <option value="all" selected>All</a>
			<option value="Magazine">Magazine</a><option value="Research">Research</a><option value="Book">Book</a><option value="Newspaper">Newspaper</a><option value="Internal">Internal</a><option value="Journal">Journal</a><option value="Patent">Patent</a><option value="Funding">Funding</a><option value=""></a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function placeSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categoryplace">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function subscriptionSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultsubscription">
				    <option value="all" selected>All</a>
	...
	function optlistSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typeoptlist">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function pageSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typepage">
				    <option value="all" selected>All</a>
			<option value="JSON">JSON</a><option value="HTML">HTML</a><option value="CSS">CSS</a><option value="XSL">XSL</a><option value="email">Email</a><option value="JS">JS</a><option value="XML">XML</a><option value="RSS">RSS</a><option value="TEXT">TEXT</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function courseSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultcourse">
				    <option value="all" selected>All</a>
	...
	function citeSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultcite">
				    <option value="all" selected>All</a>
	...
	function topicSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typetopic">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Status <select name="status" id="statustopic">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function personSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Status <select name="status" id="statusperson">
				    <option value="all" selected>All</a>
			<option value="registered">Registered</a><option value="anon">Anon</a><option value="admin">Admin</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function boxSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultbox">
				    <option value="all" selected>All</a>
	...
	function presentationSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Catdetails <select name="catdetails" id="catdetailspresentation">
				    <option value="all" selected>All</a>
			<option value="Poster">Poster</a><option value="Interview">Interview</a><option value="Panel">Panel</a><option value="Lecture">Lecture</a><option value="Seminar">Seminar</a><option value="Keynote">Keynote</a><option value="Debate">Debate</a><option value="Workshop">Workshop</a>
							</select></div>
				<div class="table-list-search-form">Category <select name="category" id="categorypresentation">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function conceptSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categoryconcept">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Genre <select name="genre" id="genreconcept">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function formSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultform">
				    <option value="all" selected>All</a>
	...
	function linkSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categorylink">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typelink">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Section <select name="section" id="sectionlink">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Status <select name="status" id="statuslink">
				    <option value="all" selected>All</a>
			<option value="Stale">Stale</a><option value="Fresh">Fresh</a><option value="Posted">Posted</a><option value="Retired">Retired</a>
							</select></div>
				<div class="table-list-search-form">Genre <select name="genre" id="genrelink">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function productSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typeproduct">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Genre <select name="genre" id="genreproduct">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Category <select name="category" id="categoryproduct">
				    <option value="all" selected>All</a>
			<option value="AR">AR</a><option value="Microcontent">Microcontent</a><option value="Feed/API">Feed/API</a><option value="Metadata">Metadata</a><option value="Website">Website</a><option value="Portfolio">Portfolio</a><option value="Discussion">Discussion</a><option value="Prototype">Prototype</a><option value="Message">Message</a><option value="Game">Game</a><option value="eMail">EMail</a><option value="Computer">Computer</a><option value="Team">Team</a><option value="Blog">Blog</a><option value="Advertising">Advertising</a><option value="Form">Form</a><option value="Quiz">Quiz</a><option value="Software">Software</a><option value="Competency">Competency</a><option value="Lecture">Lecture</a><option value="Note">Note</a><option value="Citation">Citation</a><option value="Simulation">Simulation</a><option value="Identity">Identity</a><option value="Screen">Screen</a><option value="Learning Content">Learning Content</a><option value="Content">Content</a><option value="Comment">Comment</a><option value="School">School</a><option value="Learning Object">Learning Object</a><option value="Animation">Animation</a><option value="File">File</a><option value="Test">Test</a><option value="VR">VR</a><option value="Project">Project</a><option value="SEO">SEO</a><option value="Social">Social</a><option value="Event">Event</a><option value="Audio">Audio</a><option value="Learning Design">Learning Design</a><option value="Student">Student</a><option value="Photo">Photo</a><option value="Class">Class</a><option value="Journal">Journal</a><option value="Image">Image</a><option value="Workforce">Workforce</a><option value="Database">Database</a><option value="Spreadsheet">Spreadsheet</a><option value="Employment">Employment</a><option value="Text">Text</a><option value="Research">Research</a><option value="Presentation">Presentation</a><option value="security">Security</a><option value="Learning">Learning</a><option value="Survey">Survey</a><option value="virtualization">Virtualization</a><option value="eBook">EBook</a><option value="Course">Course</a><option value="Payment">Payment</a><option value="3D">3D</a><option value="Video">Video</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function queueSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultqueue">
				    <option value="all" selected>All</a>
	...
	function chatSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultchat">
				    <option value="all" selected>All</a>
	...
	function fieldSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typefield">
				    <option value="all" selected>All</a>
			<option value="textarea">Textarea</a><option value="select">Select</a><option value="text">Text</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function eventSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categoryevent">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Status <select name="status" id="statusevent">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Section <select name="section" id="sectionevent">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typeevent">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function providerSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultprovider">
				    <option value="all" selected>All</a>
	...
	function banned_sitesSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultbanned_sites">
				    <option value="all" selected>All</a>
	...
	function graphSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Typeval <select name="typeval" id="typevalgraph">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typegraph">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function configSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typeconfig">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function ratingSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaultrating">
				    <option value="all" selected>All</a>
	...
	function journalSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Genre <select name="genre" id="genrejournal">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
		<div class="table-list-search-form">
	...
	function templateSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Default <select name="default" id="defaulttemplate">
				    <option value="all" selected>All</a>
	...
	function postSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Category <select name="category" id="categorypost">
				    <option value="all" selected>All</a>
			<option value="OLDaily">OLDaily</a>
							</select></div>
				<div class="table-list-search-form">Genre <select name="genre" id="genrepost">
				    <option value="all" selected>All</a>
			<option value="something else">Something</a>
							</select></div>
				<div class="table-list-search-form">Type <select name="type" id="typepost">
				    <option value="all" selected>All</a>
			<option value="musing">Musing</a><option value="article">Article</a><option value="shownotes">Shownotes</a><option value="course">Course</a><option value="comment">Comment</a><option value="announcement">Announcement</a><option value="link">Link</a><option value="preview">Preview</a>
							</select></div>
				<div class="table-list-search-form">Field <select name="field" id="fieldpost">
				    <option value="all" selected>All</a>
			<option value="Enclosure">
Enclosure</a><option value="Genre">Genre</a><option value="Audio">
Audio</a><option value="Thumbnail">Thumbnail</a><option value="Other Image">
Other Image</a><option value="Display">
Display</a><option value="Interview">Interview</a>
							</select></div>
		<div class="table-list-search-form">
		<select name="qkey">
		<option value="id"> ID</option>
	...
	function authorSearchTemplate(request) {	
		...
		<input type="hidden" name="table" value="${request.table}">		
				...
				<div class="table-list-search-form">Type <select name="type" id="typeauthor">
				    <option value="all" selected>All</a>
