...
(function($) {
     // Modified for Bootstrap 4 - S Downes Feb 11 2018
    ...
    $.fn.togglebutton = function(opts) {
        ...
        this.each(function() {
            ...
            var buttons = options.map(function(index, opt) {
                // This line modified for Bootstrap 4 - S Downes Feb 11 2018
                var button = $("<button type='button' class='btn btn-outline-secondary btn-sm'></button>")
